...
public class FunctionDSL {
   ...
   * @return Triple Function Implementation.
   */
  public static SerializableFunction<FunctionName, Pair<FunctionSignature, FunctionBuilder>> impl(
  ...
  public static SerializableSupplier<ExprValue> nullMissingHandling(
      SerializableSupplier<ExprValue> function) {
    return function;
  }
  ...
  public static SerializableTriFunction
      <ExprValue, ExprValue, ExprValue, ExprValue> nullMissingHandling(
      SerializableTriFunction<ExprValue, ExprValue, ExprValue, ExprValue> function) {
    return (v1, v2, v3) -> {
